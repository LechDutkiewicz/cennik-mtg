...
<div class="row" data-foil="<?php if ( array_key_exists(0, $is_foil) && $is_foil[0] == 1 ) { echo 'yellow'; } else { echo "0"; } ?>" data-id="<?php echo $post->ID; ?>">
	<div class="small-3 columns">
		<div class="row">
			...
			<div class="<?php echo $key; ?> small-<?php echo $key === "Edycja" ? "12" : "2"; ?> columns <?php echo $key !== "Edycja" ? "text-center" : ""; ?>"<?php if ( $key === "Ilość" || $key === "Sprzedane" && is_user_logged_in() ) { ?> data-<?php echo $key === "Ilość" ? "ilosc" : "sprzedane"; ?>="<?php echo $name;?>"<?php } ?>>
